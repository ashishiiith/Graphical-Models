...
def main():
    ...
    load_FP("../2A/model/feature-params.txt")
    load_TP("../2A/model/transition-params.txt")
   
    #total values of features learned - transition = 10*10, feature parameter = 10*321
    init_weight = zeros( [10*10+10*321] )
    #result = fmin_bfgs(f = objective_function, x0=init_weight, fprime=gradient_function)
